...
public class InfixEvaluation {
	...
	public InfixEvaluation(String infix) {
		...
		this.stack = new StackImpl<String> (this.infix.length);
	...
	/**
	 * 
	 * @return Array of string containing Postfix Expression
	 */
		...
		for (int i = 0; i <infix.length; i++){  
			...
			if ( Character.isDigit(op.charAt(0) ) )                                                  
				...
				if ( op.equals("(") ) {                                                         
					...
					while ( !stack.isStackEmpty() && operators.get(op) <= operators.get(getLastOperator() ) ) {  
	...
	public Integer evaluate() {
		...
		Stack<Integer> valueStack = new StackImpl<Integer> (1000);
	...
	public static void main(String args[]) {
		...
		String infix = "2 + 5 == 11 == 7 + 3 == 7";
		InfixEvaluation obj = new InfixEvaluation(infix);
		obj.infixToPostfixOperation().toString();
